...
function Platform() {
  return (
    <div className="flex flex-col items-center justify-center px-20 py-16 bg-white min-h-screen">
      ...
      <div className="flex items-center justify-between w-full max-w-6xl">
        ...
        <div className="relative">
          <img src={Image} alt="Course Finder" className="w-[550px] rounded-lg shadow-lg" />
          <div className="absolute bottom-[-20px] left-1/2 transform -translate-x-1/2 bg-white p-6 rounded-lg shadow-lg w-72">
