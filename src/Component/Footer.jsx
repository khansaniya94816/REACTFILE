      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-10">
          ...
          <div className="mt-4 flex flex-col md:flex-row justify-center gap-4">
            <input type="email" placeholder="Email ID" className="p-3 w-80 text-black rounded" />
            <select className="p-3 w-80 text-gray-600 rounded">
              <option>I'm Interested in</option>
            </select>
            <button className="bg-gradient-to-r from-yellow-300 to-orange-700 px-6 py-3 rounded text-white font-semibold w-52">
  Subscribe Now
</button>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-sm border-t border-gray-600 pt-10">
          <div>
            ...
            We are the fastest growing<br/> EdTech brand operating<br/> across geographies,<br/> facilitating international<br/> student recruitments by<br/> connecting students,<br/> recruitment entrepreneurs<br/> and global universities<br/> through our high-tech online<br/> platform – coursefinder.ai            </p>
          </div>
          <div>
            <h3 className="font-medium text-lg text-base text-gray-500">Study Destinations</h3>
            <ul className="mt-2 text-lg text-white w-22 space-y-1">
              <li>United States</li>
              <li>Canada</li>
          ...
          <div>
            ...
            <ul className="mt-2 text-lg w-22 text-white space-y-1">
              <li>Counselling</li>
  ...
  <div className="flex justify-center items-center gap-16 mt-6">
    ...
    <img src={ICEF} alt="Education UK" className="h-14" />
        ...
        <div className="border-t border-gray-600 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
          ...
          <p className="font-sm text-lg">Copyright © KC Overseas Education 2004-2025</p>
