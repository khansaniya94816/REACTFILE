    ...
    <div className="bg-gradient-to-b from-blue-100 to-white py-8 px-4 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col md:flex-row items-center md:w-full">
            <img src={image} alt="IELTS Prep" className="w-56 h-56 rounded-lg" />
            <div className="ml-4 flex flex-col justify-center mt-4 md:mt-0">
              <h3 className="text-blue-600 font-semibold text-sm">
      ...
      <div className="mt-6 flex justify-center gap-1 text-[#FD6D63] font-medium cursor-pointer">
        <span>Register Now</span>
        <img src={arrow} alt="Arrow" className="w-4 h-4" />
      </div>
    </div>
